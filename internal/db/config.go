...
func (d *DB) LoadConfigForUser(userID string) *config.Config {
	...
	cfg.RouteValidationMaxBuyDriftPct = parseFloat("route_validation_max_buy_drift_pct", cfg.RouteValidationMaxBuyDriftPct)
	cfg.RouteValidationMaxSellDriftPct = parseFloat("route_validation_max_sell_drift_pct", cfg.RouteValidationMaxSellDriftPct)
	cfg.RouteValidationMinProfitRetainedPct = parseFloat("route_validation_min_profit_retained_pct", cfg.RouteValidationMinProfitRetainedPct)
	cfg.RouteValidationMinLiquidityRetainedPct = parseFloat("route_validation_min_liquidity_retained_pct", cfg.RouteValidationMinLiquidityRetainedPct)
...
func (d *DB) SaveConfigForUser(userID string, cfg *config.Config) error {
	...
	pairs := map[string]string{
		...
		"route_validation_max_buy_drift_pct":          fmt.Sprintf("%g", cfg.RouteValidationMaxBuyDriftPct),
		"route_validation_max_sell_drift_pct":         fmt.Sprintf("%g", cfg.RouteValidationMaxSellDriftPct),
		"route_validation_min_profit_retained_pct":    fmt.Sprintf("%g", cfg.RouteValidationMinProfitRetainedPct),
		"route_validation_min_liquidity_retained_pct": fmt.Sprintf("%g", cfg.RouteValidationMinLiquidityRetainedPct),
